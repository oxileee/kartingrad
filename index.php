...
<head>
    <title>Картинград | Картины на заказ</title>
    <!-- Meta -->
    <meta charset="utf-8">
...
<body>
    ...
    <div id="about" class="about-section">
        <div class="container text-center">
            <h2 class="section-title">Почему именно Картинград?</h2>
    ...
    <div id="features" class="features-section">
        <div class="container text-center">
            ...
            <p class="intro">Мы предлагаем обширное количество стилей и вариантов исполнения картины</p>
            ...
            <div class="members-wrapper row">
                <div class="item col-md-6 col-sm-6 col-xs-12">
                    <div class="item-inner">
                        ...
                        <div class="member-content">
                            <h3 class="member-name">Александра</h3>
                            <div class="member-title">Администратор</div>
                ...
                <div class="item col-md-6 col-sm-6 col-xs-12">
                    <div class="item-inner">
                        ...
                        <div class="member-content">
                            <h3 class="member-name">Денис</h3>
                            <div class="member-title">Главный художник</div>
                            <ul class="social list-inline">
